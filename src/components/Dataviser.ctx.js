 ...
 * @ Modified time: 2024-07-15 15:32:43
 * @ Description:
 * 
...
export const DataviserCtx = UtilsContext({
  ...
  dvisuals: [
    // { id: '_' + crypto.randomUUID(), type: 'line', title: 'Migration Over Time', subtitle: 'Immigration over time.', x: 0, y: 0, w: 16, h: 6, orient: 'cols', exclude: [ 'sum' ] },
    // { id: '_' + crypto.randomUUID(), type: 'chord', title: 'Chord Graph', subtitle: '', x: 0, y: 8, w: 16, h: 9, orient: 'cols' },
    // { id: '_' + crypto.randomUUID(), type: 'heat', title: 'Heat Map', subtitle: '', x: 16, y: 0, w: 16, h: 9, orient: 'cols' },
    { id: '_' + crypto.randomUUID(), type: 'bar', title: 'Bar Graph', subtitle: '', x: 0 /*16*/, y: 8, w: 16, h: 6, orient: '', exclude: [], },
  ],
});
