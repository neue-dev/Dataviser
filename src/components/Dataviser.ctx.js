 ...
 * @ Modified time: 2024-07-15 13:45:18
 * @ Description:
 * 
...
export const DataviserCtx = UtilsContext({
  ...
  dvisuals: [
    // { id: '_' + crypto.randomUUID(), type: 'line', title: 'Migration Over Time', subtitle: '', x: 0, y: 0, w: 16, h: 6, orient: 'cols', exclude: [ 'sum' ] },
    ...
    { id: '_' + crypto.randomUUID(), type: 'bar', title: 'Bar Graph', subtitle: '', x: 0 /*16*/, y: 8, w: 16, h: 6, orient: 'cols', exclude: [], },
  ],
});
